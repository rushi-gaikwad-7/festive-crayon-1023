...
export default function Payment() {
    ...
    return (
        <>
            <div id={styles.head}>
                <div>
                    <img class="img" src="https://i1.lmsin.net/website_images/in/logos/header/logo-max.svg" />
                </div>
                <div>
                ...
                <div id={styles.leftcontent}>
                    ...
                    <div id={styles.shippingform}>
                        ...
                        <form id={styles.form}>
                            <div>
                                ...
                                <input id="addingFunctionality" class="checkoutinput" type="text"
                                    placeholder="Enter your full name" />
                            </div>
                            <div>
                                <label for="Name">Mobile Number</label><br />
                                <input class="checkoutinput" type="number" placeholder="Enter your Mobile Number" />
                            </div>
                            <div>
                                <label for="pincode">Pincode</label><br />
                                <input class="checkoutinput" type="number" placeholder="Enter your pincode" />
                            </div>
                            <div>
                                <label for="city">City</label><br />
                                <input class="checkoutinput" type="text" placeholder="Enter your City Or Town" />
                            </div>
                            <div>
                                <label for="">Building name or number</label><br />
                                <input class="checkoutinput" type="text" placeholder=" Enter Building Name" />
                            </div>
                            <div>
                                <label for="">Street name or number</label><br />
                                <input class="checkoutinput" type="text" placeholder="Flat/house number,Floor,Building" />
                            </div>
                            <div>
                                <label for="">Landmark</label><br />
                                <input class="checkoutinput" type="text" placeholder="Landmark" />
                            </div>
                            <div>
                                <label for="">Address</label>
                                <div>
                                    <input type="radio" /><label for="">Home</label>
                                    <input type="radio" /><label for=""></label>Office
                                </div>
                            </div>
                        </form>
                    </div>
                    <div>
                        ...
                        <div class={styles.paymentmethod}>
                            <div>
                                <input type="radio" />
                                <img height="25px" src="https://i1.lmsin.net/website_images/ae/checkout/card-payment.svg" />
                            </div>
                            <div>
                        ...
                        <div class={styles.paymentmethod}>
                            <div>
                                <input type="radio" />
                                <img height="35px" src="https://i1.lmsin.net/website_images/in/checkout/logo-emi.png" />
                            </div>
                            <div>
                                <h4>EMI</h4>
                        ...
                        <div class={styles.paymentmethod}>
                            <div>
                                <div>
                                    <input type="radio" />
                                    <img height="35px" src="https://i1.lmsin.net/website_images/ae/checkout/logo-paypal.png" />
                                </div>
                            </div>
                            <div>
                                <h4>PayPal</h4>
                        ...
                        <div class={styles.paymentmethod}>
                            <div>
                                <div>
                                    <input type="radio" />
                                    <img height="25px" src="https://i1.lmsin.net/website_images/ae/checkout/logo-cash.png" />
                                </div>
                            </div>
                            <div>
                        ...
                        <div class={styles.paymentmethod}>
                            <div>
                                <input type="radio" />
                                <img width="70px;" src="https://i1.lmsin.net/website_images/in/checkout/logo-netbanking.svg" />
                            </div>
                            <div>
                                <h4>Net Banking</h4>
                        ...
                        <div class={styles.paymentmethod}>
                            <img height="20px" src="https://i1.lmsin.net/website_images/common/images/basket/ico-gift.png" />
                            <p>Got a Promo Code?</p>
                        </div>
                        <div class={styles.paymentmethod}>
                            <img height="20px" src="https://i1.lmsin.net/website_images/in/giftcards/gift-card-icon.svg" />
                    ...
                    <div>
                        ...
                        <div id={styles.paymentimage}>
                            <div>
                                ...
                                <img height="30px" src="https://i1.lmsin.net/website_images/ae/checkout/logo-mc.png" />
                                <img height="30px" src="https://i1.lmsin.net/website_images/in/checkout/logo-rupay.svg" />
                                <img height="40px" src="https://i1.lmsin.net/website_images/ae/checkout/logo-cash.png" />
                            </div>
                            <div>
                                <img height="40px" src="https://i1.lmsin.net/website_images/in/checkout/logo-netbanking.svg" />
                                <img height="40px" src="https://i1.lmsin.net/website_images/in/checkout/logo-wallet.svg" />
                                <img height="40px" src="https://i1.lmsin.net/website_images/in/checkout/logo-rewards.svg" />
                            </div>
                        </div>
                    </div>
                </div>
