    ...
    return <>
        ...
        <div id="container" style={{  display: "flex", width: "95%", margin: "auto",gap:"20px" }}>
            ...
            <div id="left" style={{ width: "820px" }}>
                <div id="left-inner-div" style={{ margin: "10px" }}>
                    <div id="cart-div" style={{ display: "flex" }}>
                        <div><img style={{ width: "100px", margin: "auto",  }} src="https://lmsin.net/cdn-cgi/image/h=294,w=196,q=60,fit=cover/https://aaeff43fe32172cbcecc-ae2a4e9a8cbc330ede5588dedf56886e.lmsin.net/max/1000011358126-Blue-NAVY-1000011358126-27062022_01-2100.jpg" alt="" /></div>
            ...
            <div id="right" style={{height:"auto" }}>
                <div class={styles.sidbx} >

                    <div class={styles.inputBx} style={{display:"block"}}>
                        <span>Deliver To&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        <input placeholder="Enter Pincode" type="" name="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <button>Check</button>
                        <p style={{backgroundColor:"#FDEDEB",padding:"5px",marginTop:"5px",width:"380px"}}>Enter pin code in box above for delivery estimates and charges</p>
                    ...
                    <div class={styles.inputBx}>
                        <div class={styles.in1}>
                            <div class={styles.in2}>
                                <span>Total MRP</span>
                                <span>Rs. price</span>
                            </div>
                            <div class={styles.in2}>
